...
def run_optimization(
    ...
    scenarios.append(_scenario_from_solution("Current setup", current_solution, target_annual, station_times, current_workers, station_skill, opex_df, uptime, scrap_rate, "Current", monthly_rates, energy_escalation_pct, miscellaneous_cost_pct, base_labour_annual))
    ...
    for obj in objectives_to_solve:
        ...
        scenario = _scenario_from_solution(label, sol, target_annual, station_times, current_workers, station_skill, opex_df, uptime, scrap_rate, obj, monthly_rates, energy_escalation_pct, miscellaneous_cost_pct, base_labour_annual)
